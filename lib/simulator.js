...
var SimulatorColorSensor = function(options) {
  this.value = [0, 0, 0, 0];
};

SimulatorColorSensor.prototype.read = function(callback) {
...
module.exports = SimulatorColorSensor;
 
if (module.parent === null) {
  var sensor = new SimulatorColorSensor();
